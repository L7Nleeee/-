const CACHE='anledger-v100';
const ASSETS=['./','./index.html','./AnLedger_V1.0.html','./manifest.json','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png','./icons/cat-mascot.png'];
